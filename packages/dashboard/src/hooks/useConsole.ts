...
function buildOpeningTag(el: SelectedElement): string {
    const attrs: string[] = []
    if (el.attributes) {
...
function buildMultiElementContext(elements: SelectedElement[]): string {
...
function buildInspectorContext(el: SelectedElement): string {
